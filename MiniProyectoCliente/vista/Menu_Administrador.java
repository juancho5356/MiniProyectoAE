...
public class Menu_Administrador extends JFrame implements MouseListener, MouseMotionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Menu_Administrador window = new Menu_Administrador();
	...
	private void initialize() {
		...
		btnPersonas.setBackground(new Color(255, 255, 255));
		btnPersonas.setFont(new Font("Baskerville Old Face", Font.PLAIN, 14));
		btnPersonas.setBounds(289, 239, 265, 52);
		...
		btnFuncionalidades.setBounds(289, 332, 265, 52);
		...
		lblHaIniciadoSesion = new JLabel("Ha iniciado sesion como Administrador");
