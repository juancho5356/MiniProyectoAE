...
public class Menu_Aficionado extends JFrame implements MouseListener, MouseMotionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Menu_Aficionado window = new Menu_Aficionado();
	...
	private void initialize() {
		...
		lblBienvenida.setBackground(new Color(255, 255, 255));
		...
		lblHaIniciadoSesion = new JLabel("Ha iniciado sesion como Aficionado");
		...
		lblNewLabel.setIcon(new ImageIcon(Menu_Aficionado.class.getResource("/Vista/image/14.jpg")));
